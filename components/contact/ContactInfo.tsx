        ...
        <div className="space-y-6 mb-12">
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-neutral-600">hello@ricilix.com</p>
              <p className="text-neutral-600">support@ricilix.com</p>
            </div>
          </div>
          
          <div className="flex items-start gap-4">
            <div className="w-12 h-12 bg-purple-100 rounded-small flex items-center justify-center flex-shrink-0">
            ...
            <div>
              <h3 className="font-heading text-lg text-neutral-900 mb-1">Office</h3>
              <p className="text-neutral-600">123 Innovation Street</p>
