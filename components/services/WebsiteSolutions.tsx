      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-2 md:order-2">
            <div className="inline-block bg-green-100 text-green-600 px-4 py-2 rounded-md text-sm font-medium mb-6">
              Website Solutions
            </div>
            ...
            <p className="text-neutral-600 mb-6">
              ...
              We build conversion-optimized, automation-ready websites that turn traffic into
            ...
            {/* Call-to-Action */}
            <Link href="/contact" className="inline-block bg-green-600 hover:bg-green-700 text-white font-medium px-6 py-3 rounded-lg transition">
              Let's Start
            </Link>
